...
const Notes = ({ userData, className }) => {
    ...
    return (
        <div ref={elementRef} className={`h-full max-h-dvh p-5 ${className} flex flex-col overflow-hidden`}>
            <div className={`bg-white rounded-xl h-full shadow-beautiful duration-500 transition-all ${isVisible ? "" : "translate-x-full opacity-0"}`}>
                <div className="w-full h-full flex flex-col">
                    <div className={`text-xl font-bold flex items-center justify-between mx-8 mt-8 duration-500 transition-all ${isVisible ? "" : "-translate-y-32 opacity-0"}`}>
                    ...
                    <div className={`w-full px-8 duration-500 transition-all ${isVisible ? "" : "-translate-y-full opacity-0"}`}>
